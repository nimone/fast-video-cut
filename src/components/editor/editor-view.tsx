...
// Editor layout component: media panel, player canvas, cut list, timeline, toolbar.
...
import { MediaPanel, useMediaItems, extractMeta } from "./media-panel";
import type { MediaItem } from "./media-panel";
import { PlayerPanel } from "./player";
import { ShortcutHelp } from "../info/shortcut-help";
...
import { useProjectStore, type ProjectStore } from "../../store/project-store";
